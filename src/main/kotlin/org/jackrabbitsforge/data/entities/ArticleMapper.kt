...
import org.jackrabbitsforge.data.dto.ArticleDto
...
abstract class ArticleMapper {
    ...
    abstract fun toEntity(articleDto: ArticleDto): Article

    abstract fun toDto(article: Article): ArticleDto

    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    abstract fun partialUpdate(articleDto: ArticleDto, @MappingTarget article: Article): Article
}