...
export type SchemaFeedListOutDtoOutput = components['schemas']['FeedListOutDto_Output'];
export type SchemaFeedOutDtoOutput = components['schemas']['FeedOutDto_Output'];
